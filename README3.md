...
### Основная идея
Аналог бинарного поиска, но деление массива происходит в пропорциях, задаваемых числами Фибоначчи.

### Особенности выполнения
- Используются три последовательных числа Фибоначчи.
- Область поиска сокращается на величину `F(m−2)`.
- Не требует операций умножения/деления.
